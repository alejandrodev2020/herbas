                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                                ...
                                <input type="hidden" v-model="tipo_documento">
                                <!-- <div class="form-group row">
                                ...
                                <input type="hidden" v-model="contacto" class="form-control" placeholder="Nombre del contacto">
                                ...
                                <input type="hidden" v-model="telefono_contacto" class="form-control" placeholder="Teléfono del contacto">
